...
const DefaultPrompt: PromptConfig = {
  ...
  image: {
    model: "dall-e-3",
    instructions:
      "You are a botanist with a love for pixel art. Create an 8 bit pixel art image for a botanical game on a solely white background in the art style of Stardew Valley, based on the description that follows. Make sure there is no texts the image. Just the plant in the middle of the image. Don't forget the background color of the image should be #FFFFFF pure white. Here is the description:"
  }
};
