...
const DefaultPrompt: PromptConfig = {
  preamble: {
    ...
    text: "Imagine you are a knowledgeable botanist with a flair for descriptive writing, and an interest in science fiction.",
  },
  explanation: {
    label: "Explanation",
    description:
  ...
  instructions: {
    ...
    description:
      "Remind the AI what you are looking for (combining the two plants) and, if necessary, remind them of the fields (keys) that you expect to see. Definitely state that you only want pure JSON in the response, no other text.",
