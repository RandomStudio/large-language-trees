    ...
    messages: [
      {
        role: "user",
        content:
          "Imagine you are a knowledgeable botanist with a flair for descriptive writing, and an interest in science fiction. I manage to cross-pollinate two plants. Don't worry about whether this is physically possible in real life, but feel free to speculate on the likely outcome. \n\n" +
          'I will describe each plant in JSON form, giving its common name and by a brief description, followed by a set of key-value pairs for "characteristics". With the information about the two parent plants, try to come up with a plausible new plant that would result from the cross-pollination.\n\n' +
          "First plant JSON:\n" +
          JSON.stringify(
            {
