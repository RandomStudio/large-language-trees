<script lang="ts">
    ...
    function displayPlant(p5: p5) {
        ...
        console.log(color);
        let lengthofstem = plant.properties.lengthofstem as number;
        let numberpetals = plant.properties.numberpetals as number;
    ...
    function createPetals(
        ...
        if (rgb) {
            ...
            console.error(
                `could not get RGB for colour "${flowerColor}" in ${Object.keys(colorsRGB)}`,
            );
        }
    }
