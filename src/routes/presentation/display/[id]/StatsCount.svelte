...
<div
  class="w-screen h-screen relative bg-gradient-to-t from-roel_green from-20% to-roel_blue to-80% overflow-hidden"
>
  <DisplayGarden
    xGarden={-180}
    yGarden={20}
  ...
  <div
    class="absolute w-screen h-screen flex flex-col justify-end py-[3vh] z-9000"
  >
    <div
