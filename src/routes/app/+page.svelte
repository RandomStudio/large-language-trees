...
<div class="mx-10 pt-[15vh] font-primer text-6xl text-roel_blue">
  ...
  {#if form?.message}
    <div class="text-roel_blue text-left text-base ml-4">
      Error: {form.message}
    </div>
  {/if}
</div>
<div
  class="font-primer text-left mt-5 text-base mx-0 text-roel_green bg-roel_blue"
>
  <div class="p-10">
    <p>
      Welcome to the Garden of Random, where digital abundance is sprouting.
      <br />
