...
<div class="fixed bottom-0 left-10 right-10 content-center buttonContainer">
  <button
    ...
    class="w-full bg-roel_blue text-roel_green font-primer text-lg px-4 py-[0.5rem] mb-5 border-2 border-roel_blue rounded-full button-with-active select-none"
