...
<div
  class="min-h-full w-full flex flex-row text-small {hasScroll && 'hasScroll'}"
>
  ...
  {:else}
    <div class="standard-gradient px-10">
      <div class="page-contents h-full grid gridWrapper">
        <header class="py-4">
          {#if title}
...
<style scoped>
  ...
  .gridWrapper:global(.hasScroll) {
    grid-template-rows: max-content auto 180px;
  }
</style>
